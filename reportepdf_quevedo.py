    ...
    try:
        ...
        if not df.empty:
            ...
            if st.button("🚀 Crear Reporte PDF"):
                ...
                st.download_button(label="⬇️ Descargar", data=pdf_bytes, file_name="Reporte_Salud.pdf", mime="application/pdf")
        else:
